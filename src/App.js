    ...
    <Router forceRefresh={true}>
      <GlobalContext.Provider value={{ dispatch: dispatch, state: state }}>
        ...
        <Switch>
          ...
          <Route key="movie" path="/movie/:id" children={<Movie />}></Route>
          <Route key="tv" path="/tv/:id" children={<Tv />}></Route>
          <Route key="person" path="/person/:id" children={<Person />}></Route>
          <Route key="search" path="/search" children={<SearchSite />}></Route>
          <Route key="*" path="*">
            <Error />
          </Route>
        </Switch>
