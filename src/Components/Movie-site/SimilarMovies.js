        ...
        <>
          <div className='smilar-movies-div'>
            <div className='similar-header'>
              <h2
                className={
                  belongs_to_collection && selected === 0 ? 'selectedop' : ''
                }
                onClick={() => {
                  setSelected(0);
                }}
              ...
              {belongs_to_collection && (
                <h2
                  className={selected === 1 ? 'selectedop' : ''}
                  onClick={() => {
                    setSelected(1);
                  }}
                >
            ...
            <div
              className={
                selected !== 0 ? 'similar-movies hide' : 'similar-movies'
              }
            >
              {similarMovies.map((mov) => {
                const { id, title, vote_average, poster_path, overview } = mov;
            ...
            <div
              className={
                selected !== 1 ? 'collection-movies hide' : 'collection-movies'
              }
            >
